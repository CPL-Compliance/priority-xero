...
export default defineComponent({
  async run({ steps, $ }) {
    ...
    // Get tax rate types
    const { requested: requestedTaxType, exempted: exemptedTaxType } = steps.Xero_Event_Gateway.$return_value.tax_rate_type_map;
    ...
    // Check if any HistoryRecord has "Changes" === "Approved"
    const hasApprovedChange = fullInvoiceHistory.HistoryRecords.some(
      record => record.Changes === "Approved"
    );
